...
MODE="${1:-full}"
GPU_LIST="${2:-0}"
LOG_ROOT="${3:-logs_stage_label_efficiency_pretrained_dynamic_center}"
...
BASE_CONFIGS=(
  "config/base_stage_label_efficiency_pretrained_dynamic_center_1.yaml"
  "config/base_stage_label_efficiency_pretrained_dynamic_center_2.yaml"
  "config/base_stage_label_efficiency_pretrained_dynamic_center_3.yaml"
  "config/base_stage_label_efficiency_pretrained_dynamic_center_4.yaml"
  "config/base_stage_label_efficiency_pretrained_dynamic_center_5.yaml"
)

TRAIN_CONFIGS=(
  "config/train_stage_label_eff_pretrained_dynamic_center_frac1p0.yaml"
  "config/train_stage_label_eff_pretrained_dynamic_center_frac0p5.yaml"
  "config/train_stage_label_eff_pretrained_dynamic_center_frac0p2.yaml"
  "config/train_stage_label_eff_pretrained_dynamic_center_frac0p1.yaml"
  "config/train_stage_label_eff_pretrained_dynamic_center_frac0p05.yaml"
)
